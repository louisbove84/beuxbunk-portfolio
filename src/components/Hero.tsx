...
const Hero = () => {
  return (
    <section 
      ...
      style={{
        backgroundImage: `url(${VISUAL_ASSETS.heroBackground})`,
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-100 drop-shadow-md mb-8 max-w-3xl mx-auto animate-fade-in-delay">
            {CONTACT_INFO.title}
          </p>
          
          <p className="text-lg text-gray-200 drop-shadow-md mb-12 max-w-2xl mx-auto animate-fade-in-delay-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-3">
            <button
              ...
              className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              View My Work
            </button>
            ...
            <button
              ...
              className="px-8 py-4 bg-white text-gray-800 font-semibold rounded-lg hover:bg-gray-100 hover:text-blue-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Get In Touch
            </button>
          </div>
          ...
          <div className="flex justify-center space-x-6 mt-12 animate-fade-in-delay-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-gray-700 dark:hover:text-white transform hover:scale-110 transition-all duration-300"
              aria-label="GitHub"
            >
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
